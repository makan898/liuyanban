				...
				<tr>
					<td >
						<div class="c_nr">
							<div>
							<div class="c_show">
								<form name="denglu" action="change_password.php" method="post" onsubmit="return chickuser(this);">
									<table cellpadding="0" cellspacing="0" border="0" >									<tr>
										...
										<tr align="center">
											<td style="padding: 25px 0px 0px 0px;"><input name="sub" type="submit" value="Change Password" style="width: 100px;"/></td>
										</tr>
									</table>
								</form>
							</div>
